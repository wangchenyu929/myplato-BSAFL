...
class Server(base.Server):
    ...
    def __init__(self, model=None, algorithm=None, trainer=None):
        ...
        """
        logging.info("plato->servers fedavg.py init()")
        """
    ...
    async def select_clients(self):
        logging.info("plato->servers fedavg.py select_clients()")
        self.round_start_time = time.perf_counter()
        await super().select_clients()

    def extract_client_updates(self, updates):
        """Extract the model weight updates from client updates."""
        logging.info("plato->servers fedavg.py extract_client_updates()")
        weights_received = [payload for (__, payload) in updates]
        return self.algorithm.compute_weight_updates(weights_received)

    async def aggregate_weights(self, updates):
        """Aggregate the reported weight updates from the selected clients."""
        logging.info("plato->servers fedavg.py aggregate_weights()")
    ...
    async def federated_averaging(self, updates):
        ...
        logging.info("plato->servers fedavg.py federated_averaging()")
    ...
    async def process_reports(self):
        ...
        logging.info("plato->servers fedavg.py process_reports()")
    ...
    def accuracy_averaging(reports):
        ...
        logging.info("plato->servers fedavg.py accuracy_averaging()")
