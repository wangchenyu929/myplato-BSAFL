...
class Server(fedavg.Server):    
    ...
    async def select_clients(self):
        ...
        logging.info("clients pool:")
        logging.info(self.clients_pool)
        logging.info("selected clients:")
    ...
    async def client_payload_done(self, sid, data, s3_key=None):
        ...
        if len(self.response_clients) == len(self.selected_clients):
            logging.info(
