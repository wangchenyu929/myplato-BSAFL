...
class Client(base.Client):
    ...
    def __init__(self,
        ...
        """
        # logging.info("plato->clients simple.py init()")
        """
    ...
    def configure(self) -> None:
        ...
        # logging.info("plato->clients simple.py configure()")
        super().configure()
    ...
    def load_data(self) -> None:
        ...
        # logging.info("plato->clients simple.py load_data()")
        ...
        # 这里的train set和test set是整个数据集的训练集和测试集
        # 拿MNIST举例就是60000和10000
        if hasattr(Config().trainer, 'use_mindspore'):
            ...
            # logging.info("client @%d train set length: %d",self.client_id,self.datasource.num_train_examples())
            # logging.info("client @%d test set length: %d",self.client_id,self.datasource.num_test_examples())
    ...
    def load_payload(self, server_payload) -> None:
        ...
        # logging.info("plato->clients simple.py load_payload()")
