...
class ClientEvents(socketio.AsyncClientNamespace):
    ...
    def __init__(self, namespace, plato_client):
        ...
        """
        # logging.info("plato->clients base.py class.ClientEvents init()")
        """
    ...
    async def on_payload(self, data):
        # logging.info("client #%d on_payload is on",data['id'])
...
class Client:
    ...
    def __init__(self) -> None:
        # logging.info("plato->clients base.py class.Client init()")
    ...
    async def payload_to_arrive(self, response) -> None:
        ...
        # logging.info("plato->clients base.py payload_to_arrive()")
    ...
    async def payload_arrived(self, client_id) -> None:
        ...
        # logging.info("plato->clients base.py payload_arrived()")
    ...
    async def payload_done(self, client_id, s3_key=None) -> None:
        ...
        # logging.info("plato->clients base.py payload_done()")
    ...
    async def send_in_chunks(self, data) -> None:
        ...
        # logging.info("plato->clients base.py send_in_chunks()")
    ...
    async def send(self, payload) -> None:
        ...
        # logging.info("plato->clients base.py send()")
