...
class ServerEvents(socketio.AsyncNamespace):
    ...
    def __init__(self, namespace, plato_server):
        ...
        # logging.info("plato->servers base.py class.ServerEvents init()")
...
class Server:
    ...
    def __init__(self):
        ...
        """
        # logging.info("plato->servers base.py class.server init()")
        """
    ...
    def run(self,
        ...
        # logging.info("plato->servers base.py class.server run()")
    ...
    async def register_client(self, sid, client_id):
        # logging.info("plato->servers base.py class.server register_client()")
    ...
    def start_clients(client=None,
                      ...
                      edge_client=None,
                      trainer=None):
        # logging.info("plato->servers base.py class.server start_clients()")
    ...
    def choose_clients(self, clients_pool, clients_count):
        ...
        # logging.info("plato->servers base.py class.server choose_clients()")
    ...
    async def periodic(self, periodic_interval):
        ...
        """
        # logging.info("plato->servers base.py class.server periodic()")
        while True:
    ...
    async def periodic_task(self):
        ...
        logging.info("plato->servers base.py class.server periodic_task()")
    ...
    async def client_payload_done(self, sid, client_id, s3_key=None):
        # logging.info("plato->servers base.py class.server client_payload_done()")
    ...
    async def wrap_up(self):
        ...
        # logging.info("plato->servers base.py class.server wrap_up()")
