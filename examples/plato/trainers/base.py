...
class Trainer(ABC):
    ...
    def __init__(self):
        ...
        """
        # logging.info("plato->trainers base.py init()")
        """
    ...
    def run_sql_statement(statement: str, params: tuple = None):
        ...
        #logging.info("plato->trainers base.py run_sql_statement()")
        while True:
            try:
    ...
    def set_client_id(self, client_id):
        ...
        """
        # logging.info("plato->trainers base.py set_client_id()")
    ...
    def start_training(self):
        ...
        been reached."""
        # logging.info("plato->trainers base.py start_training()")
    ...
    def pause_training(self):
        ...
        # logging.info("plato->trainers base.py pause_training()")
